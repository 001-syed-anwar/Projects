...
<div class="d-flex justify-content-center" style="color:black;margin-top:10rem;">
    <div class="row">
        <div class="col-md-6 col-sm-12 mb-5 text-center"><a href="./newdoc.php" class="btn btn-primary">
For New Customer
</a>
    </div>
        <div class="col-md-6  col-sm-12">
        <a href="./exsisting.php" class="btn btn-primary text-center" style="width:100%;">
        For Exsisting Customer
        </a>
    </div>
    </div>
    </div>
