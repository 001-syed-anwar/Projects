...
// $host="localhost"; for now work on the new customer if its working then i will implement the same in exsisting customer
// $user="pms_test";
// $pass="root";
// $db="newcs";
...
<head>
    ...
    <title>Mobilo-Exsisting Customer</title>
    <link
...
<div class="container my-5 p-5">
    <div class="text-center h3">Exsisting Customer</div>
...
if (isset($_POST['search'])) {
  ...
  $query = "SELECT * FROM tallyclientmaster  WHERE companyname LIKE '%$item%' LIMIT 20";
  ...
  if ($result) {
      if (mysqli_num_rows($result) > 0) {
          ...
          while ($row = mysqli_fetch_assoc($result)) {
              echo '  <a  class="col-xs-12 col-md-6 col-lg-3 mb-3" href="newdoc.php?masterid='.$row['masterid'].'&companyname='.$row['companyname'].'">
              <div class="card" style="width:97%;"> 
              <h3 class="card__title">'.$i.'.'.$row['companyname'].'</h3>
              </div>
              </a>';
              $i++;
          }
