...
<div class="container my-5 p-5">
    <div class="text-center h3">New Customer</div>
...
if (mysqli_num_rows($sql)>0) {
    while ($row = $sql->fetch_assoc()) {
        ...
        foreach ($flags as $flag) {
            ...
            echo "<option class='tag-value' value='$flag' data-badge=''>".ucfirst($flag)."</option>";
        }
    }
} else {
...
<div class="card my-2" style="width:97%;" id="search_result">
    
   

</div>

  <!-- <div class="text-center shadow card" id="search_result">
