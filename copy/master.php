...
if (isset($_POST['submit'])) {
    ...
    if ($doctype == 'poster' && ($fileExtension == 'jpg' || $fileExtension == 'jpeg')) {
...
$uploadedFilePath = $uploadDirectory . $newFilename;
    ...
    if (move_uploaded_file($_FILES['file']['tmp_name'], $uploadedFilePath)) {
        ...
        $sql = "INSERT INTO postermaster (posterID, posterCode, posterName, RefDatepos, RefNopos, CompanyNamepos, ContactPersonpos, ContactMobilepos, SaleValuepos, Descriptionpos, TaxPos, TotalPos, ExecutiveNamePos, ExecutiveMobilePos, Product, SaleValueDef, TaxDef, TotalDef, DescriptionDef, OrderSeq, Flags, DocType, keywords, file_name,created_at, created_by) VALUES ('$posterID', '$posterCode', '$posterName', '$refDatePos', '$refNoPos', '$companyNamePos', '$contactPersonPos', '$contactMobilePos', '$saleValuePos', '$descriptionPos', '$taxPos', '$totalPos', '$executiveNamePos', '$executiveMobilePos', '$product', '$saleValueDef', '$taxDef', '$totalDef', '$descriptionDef', '1', '$flags', '$doctype', '$keywords','$newFilename' , 'CURRENT_TIMESTAMP', '$username')";
...
?>
    <input  type="text" class="form-control rounded mb-3" name="posterID"  placeholder="Poster ID"  value="<?php echo $row['posterID']+1; ?>">
    ...
    <label class="form-label d-flex flex-start">Poster Name</label>
    <input  type="text" class="form-control rounded mb-3" name="postername"  placeholder="Poster Name">
    ...
    <label class="form-label d-flex flex-start">Flags</label>
    <input  type="text" class="form-control rounded mb-3" name="Flags"  placeholder="Eg: important,favourite">
    <label class="form-label d-flex flex-start">Doc Type</label>
    <select class="form-select mb-3" name="Doctype">
        <option value="poster">Poster-For Image</option>
        <option value="quotation">Quotation-For PDF</option>
    </select>
    
    <label class="form-label d-flex flex-start">Choose File</label>
    <input  type="file" class="form-control rounded mb-3" name="file" >

    <label class="form-label d-flex flex-start">keywords</label>
    <input  type="text" class="form-control rounded mb-3" name="keywords"  placeholder="Eg: Tally ERP">
    <input  type="submit" class="btn-primary btn " name="submit" value="submit">

</form>
<!--  INSERT INTO postermaster (posterID, posterCode, posterName, RefDatepos, RefNopos, CompanyNamepos, ContactPersonpos, ContactMobilepos, SaleValuepos, Descriptionpos, TaxPos, TotalPos, ExecutiveNamePos, ExecutiveMobilePos, Product, SaleValueDef, TaxDef, TotalDef, DescriptionDef, OrderSeq, Flags, DocType, keywords, created_at, created_by) VALUES ('1', 'RWS-001', 'TallySU', '120/120/14/white', '150/130/14/white', '90/160/14/white', '90/180/14/white', '90/184/14/white', '90/187/14/white', '90/190/14/white', '90/200/14/white', '90/205/14/white', '90/214/14/white', '90/225/14/white', 'TallyERP', '10000', '1000', '10000', 'This is an Tally ERP Product', '1', 'favorite,important', 'PDF', 'TallySU', '2024-01-10', 'ahmed'); -->
